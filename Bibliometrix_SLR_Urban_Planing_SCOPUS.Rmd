...
To create this report, materials were collected from the Scopus database on July 19, 2022, using the search expression TITLE-ABS-KEY(("urban planning") AND ("disaster" OR "catastrophe" OR "calamity") ).

***Results:** documents, 992 in english language*

*Databases used are available at [GitHub](https://github.com/jairoalmeid/Bibliometrix)*

*This report illustrates in practice the use of the bibliometrix library documented in: [Bibliometrix Documentation](https://cran.r-project.org/web/packages/bibliometrix/bibliometrix.pdf)*
...
file <- c("https://raw.githubusercontent.com/jairoalmeid/Bibliometrix/main/scopus.csv")

database <- convert2df(file, dbsource = "scopus", format = "csv")
```
...
"It performs a bibliometric analysis of a dataset imported from SCOPUS and Clarivate Analytics Web of Science databases. *biblioAnalysis* returns an object of class 'bibliometrix'" [1]
...
" *biblioNetwork* creates different bibliographic networks from a bibliographic data frame." [1]
...
"It performs a coupling network analysis and plots community detection results on a bi-dimensional map (Coupling Map)"[1]
