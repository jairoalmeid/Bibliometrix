...
Scopus_file <- c("https://raw.githubusercontent.com/jairoalmeid/Bibliometrix/main/scopus.csv")
Wos_file <- c("https://raw.githubusercontent.com/jairoalmeid/Bibliometrix/main/WebOfScience_export_part1.bib", "https://raw.githubusercontent.com/jairoalmeid/Bibliometrix/main/WebOfScience_export_part2.bib")

database_scopus <- convert2df(Scopus_file, dbsource = "scopus", format = "csv")
database_wos <- convert2df(Wos_file, dbsource = "wos", format = "bibtex")

database=mergeDbSources(database_scopus, database_wos, remove.duplicated = TRUE)
```
